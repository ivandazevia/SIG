    ...
    <nav class="navbar navbar-expand-lg navbar-light">
            <div class="collapse navbar-collapse justify-content-md-center">
                <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item active"><a class="nav-link active w3-black w3-hover-opacity-off w3-padding-large" href="findroad_menu.php"><i class="fa fa-route"></i> Route to The Restaurant </a></li>
    ...
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%;">
      <div class="w3-padding-large " style="background-color: rgba(0, 0, 0, 0.7); ">
        <div class="col-sm-12">
                ...
                <div class="col-2">
                  <select class="btn btn-secondary btn-outline-primary btn-block mb-2" id=listuniv name="product" width="10000" style="width: 360px;">
                              <option disabled selected>Choose The Restaurant</option> 
                              <option value="1">Rumah Makan Sederhana</option> 
                              <option value="2">MCDonalds Mulyosari</option>                           
                              <option value="3">Food Festival Pakuwon City</option>
                              <option value="4">Soto Ayam Lamongan Cak Har</option>
                              <option value="5">Communal Coffee & Eatery</option>
                              <option value="6">Steak Hotel by HOLYCOW!</option>
                              <option value="7">Dapoer Mantab</option>
                              <option value="8">Sop Ayam Pak Min Klaten</option>
                              <option value="9">Niki Sae Restoran</option>                                     
                              <option value="10">Aiola Eatery</option> 
                              <option value="11">Bakso Boedjangan Citraland</option> 
                              <option value="12">Depot Bu Rudy</option> 
                              <option value="13">Sego Sambel Mak Yeye</option> 
                              <option value="14">Bubur Ayam Mang Dudung</option> 
                              <option value="15">Nasi Bebek Tugu Pahlawan</option> 
                  </select>
                </div>
              </div>
                <div class="form-group row">
