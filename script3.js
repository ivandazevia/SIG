...
function execute(){
  ...
  var done= new Promise(function(resolve,reject){
      ...
      var url="http://localhost/FP_SIG/find3.php?x1="+tempp[0]+"&y1="+tempp[1]+"&x2="+tempp1[0]+"&y2="+tempp1[1];
  ...
  var done1= new Promise(function(resolve,reject){
      ...
      var oReq = new XMLHttpRequest();
      oReq.onload = reqListener;
      var url="http://localhost/FP_SIG/jarak3.php?x1="+tempp[0]+"&y1="+tempp[1]+"&x2="+tempp1[0]+"&y2="+tempp1[1];
